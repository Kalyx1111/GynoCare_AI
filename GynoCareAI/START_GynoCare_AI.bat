...
call :LOG "===== GynoCare AI Launch Started %DATE% %TIME% ====="
call :LOG "Base folder: %BASEDIR%"

cls
echo.
echo  ================================================================
echo   GynoCare AI  -  Women's Health Intelligence Platform  v1.0
echo  ================================================================
echo.
echo  MEDICAL DISCLAIMER:
echo  This is an AI Research Tool ONLY. Not medical advice.
echo  ALWAYS consult your gynaecologist before any decision.
echo  For emergencies call 108 (India) / 999 (UK) / 911 (US)
echo.
echo  ================================================================
echo.
...
:: STEP 7 - START SERVER
:: ---------------------------------------------------------------
echo  [STEP 7/7]  Starting GynoCare AI server...
...
start "GynoCare AI Server" cmd /k "echo GynoCare AI Server - Keep Open && "%VPYTHON%" "%BASEDIR%\server.py" --port %PORT%"
...
echo   Consult your gynaecologist before any health decision.
echo   EMERGENCY: Call 108 (India) / 999 (UK) / 911 (US)
echo  ================================================================
echo.
...
:QUIT
echo  Stopping GynoCare AI...
taskkill /FI "WINDOWTITLE eq GynoCare AI Server*" /F >nul 2>&1
for /f "tokens=5" %%P in ('netstat -ano 2^>nul ^| findstr ":%PORT% "') do taskkill /PID %%P /F >nul 2>&1
