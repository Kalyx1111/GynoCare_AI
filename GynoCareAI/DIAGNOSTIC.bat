...
title GynoCare AI - DIAGNOSTIC TOOL
...
echo.
echo  ================================================================
echo   GynoCare AI  -  FULL DIAGNOSTIC TOOL
echo  ================================================================
echo  Running system check. Report saved to logs folder.
echo  ================================================================
echo.

echo GynoCare AI Diagnostic Report > "%RPT%"
...
if exist "%VENV_DIR%\Scripts\python.exe" (
    ...
    call :FAIL "VEnv: NOT CREATED - run START_GynoCare_AI.bat first"
)
...
if %errorlevel%==0 (
    ...
    call :WARN "  Server NOT running - start with START_GynoCare_AI.bat"
)
...
if /i "%DC%"=="S" call "%BASEDIR%\START_GynoCare_AI.bat" & exit /b 0
if /i "%DC%"=="X" exit /b 0
goto :DIAG_MENU
