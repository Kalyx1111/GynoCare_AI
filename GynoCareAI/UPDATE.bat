...
if not exist "%VENV_DIR%\Scripts\pip.exe" (
    echo   [FAIL]  Venv not found. Run START_GynoCare_AI.bat first.
    pause & exit /b 1
)
...
echo.
echo  ================================================================
echo   Update complete. Restart GynoCare AI to use new packages.
echo   Log: %LOGFILE%
echo  ================================================================
echo.
pause
