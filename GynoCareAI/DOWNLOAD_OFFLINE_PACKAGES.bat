...
title GynoCare AI - Download Offline Packages
...
echo.
echo  ================================================================
echo   GynoCare AI  -  OFFLINE PACKAGE DOWNLOADER
echo  ================================================================
echo  Downloads all required packages to this folder.
echo  After this, GynoCare AI works WITHOUT internet.
...
if exist "%VENV_DIR%\Scripts\pip.exe" (set "PIP=%VENV_DIR%\Scripts\pip.exe" & echo   [ OK ]  Using venv pip.) else (
    ...
    if !errorlevel!==0 (set "PIP=pip" & echo   [ OK ]  Using system pip.) else (
        echo   [FAIL]  pip not found. Run START_GynoCare_AI.bat first.
        pause & exit /b 1
    )
)
echo.
...
(
echo GynoCare AI Offline Cache Manifest
...
echo   GynoCare AI will now work WITHOUT internet.
echo   Just run START_GynoCare_AI.bat normally.
echo  ================================================================
echo.
pause
